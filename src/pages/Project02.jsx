...
function Project02(){
  return(
    <div className="container">
      <h2 className="proj-title">The Coder Path</h2>
      <h3 className="proj-subtitle">Game concept</h3>
      ...
      <h4 className="proj-subtitle">Front-end path</h4>
      ...
      <p>In level 1 he will see a door that must be open so as to pass the level, however, not by pressing a button, but by coding. He will get close to the door, interact with it to access files and modify them with the IDE.</p>
